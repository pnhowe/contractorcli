/*Package contractor - Automatically generated by cinp-codegen from /api/v1/Site/ at 2020-02-24T22:51:21.147599
 */
package contractor
...
func (object *SiteSite) AsMap() *map[string]interface{} {
...
func (service *Contractor) SiteSiteGet(id string) (*SiteSite, error) {
	//object := SiteSite{cinp: service.cinp}
