/*Package contractor - Automatically generated by cinp-codegen from /api/v1/PostOffice/ at 2020-02-24T22:51:21.147599
 */
package contractor
...
func (object *PostofficeFoundationPost) AsMap() *map[string]interface{} {
...
func (service *Contractor) PostofficeFoundationPostGet(id string) (*PostofficeFoundationPost, error) {
	//object := PostofficeFoundationPost{cinp: service.cinp}
...
func (service *Contractor) PostofficeFoundationPostList(filterName string, filterValues map[string]interface{}) <-chan *PostofficeFoundationPost {
	...
	go func() {
		defer close(out)
		object, ok := (<-in).(*PostofficeFoundationPost)
		if ok {
			out <- object
		}
	}()
...
// AsMap returns a map[string]interface{} that is required for create and update
func (object *PostofficeStructurePost) AsMap() *map[string]interface{} {
	return &map[string]interface{}{ 
	"name": object.Name,
	"updated": object.Updated,
	"created": object.Created,
...
func (service *Contractor) PostofficeStructurePostGet(id string) (*PostofficeStructurePost, error) {
	//object := PostofficeStructurePost{cinp: service.cinp}
...
func (service *Contractor) PostofficeStructurePostList(filterName string, filterValues map[string]interface{}) <-chan *PostofficeStructurePost {
	...
	go func() {
		defer close(out)
		object, ok := (<-in).(*PostofficeStructurePost)
		if ok {
			out <- object
		}
	}()
...
type PostofficeFoundationBox struct {
  ...
  cinp *cinp.CInP
	...
	Proxy string `json:"proxy"` // String
	Type string `json:"type"` // String
	OneShot string `json:"one_shot"` // Boolean
	ExtraData map[string]interface{} `json:"extra_data"` // Map
	Expires time.Time `json:"expires"` // DateTime
	Updated time.Time `json:"updated"` // DateTime
	Created time.Time `json:"created"` // DateTime
	Foundation string `json:"foundation"` // Model
}
...
// AsMap returns a map[string]interface{} that is required for create and update
func (object *PostofficeFoundationBox) AsMap() *map[string]interface{} {
	return &map[string]interface{}{ 
	"url": object.URL,
	"proxy": object.Proxy,
	"type": object.Type,
...
func (service *Contractor) PostofficeFoundationBoxGet(id string) (*PostofficeFoundationBox, error) {
	//object := PostofficeFoundationBox{cinp: service.cinp}
...
func (service *Contractor) PostofficeFoundationBoxList(filterName string, filterValues map[string]interface{}) <-chan *PostofficeFoundationBox {
	...
	go func() {
		defer close(out)
		object, ok := (<-in).(*PostofficeFoundationBox)
		if ok {
			out <- object
		}
	}()
...
func (object *PostofficeFoundationBox) CallExtend(additional_hours string) (string, error) {
...
// AsMap returns a map[string]interface{} that is required for create and update
func (object *PostofficeStructureBox) AsMap() *map[string]interface{} {
	return &map[string]interface{}{ 
	"url": object.URL,
	"proxy": object.Proxy,
	"type": object.Type,
...
func (service *Contractor) PostofficeStructureBoxGet(id string) (*PostofficeStructureBox, error) {
	//object := PostofficeStructureBox{cinp: service.cinp}
...
func (service *Contractor) PostofficeStructureBoxList(filterName string, filterValues map[string]interface{}) <-chan *PostofficeStructureBox {
	...
	go func() {
		defer close(out)
		object, ok := (<-in).(*PostofficeStructureBox)
		if ok {
			out <- object
		}
	}()
...
// CallExtend calls extendNone
func (object *PostofficeStructureBox) CallExtend(additional_hours string) (string, error) {
	args := map[string]interface{}{ 
		"additional_hours": additional_hours,
}
	_, _, _, ids, _, err := object.cinp.Split(object.GetID())
