/*Package contractor - Automatically generated by cinp-codegen from /api/v1/Building/ at 2020-02-24T22:51:21.147599
 */
package contractor
...
type BuildingFoundation struct {
	cinp.BaseObject
  cinp *cinp.CInP
	Locator string `json:"locator"` // String
	Site string `json:"site"` // Model
	Blueprint string `json:"blueprint"` // Model
	IDMap string `json:"id_map"` // String
	LocatedAt time.Time `json:"located_at"` // DateTime
	BuiltAt time.Time `json:"built_at"` // DateTime
	Updated time.Time `json:"updated"` // DateTime
	Created time.Time `json:"created"` // DateTime
	State string `json:"state"` // String
	Type string `json:"type"` // String
	ClassList string `json:"class_list"` // String
	Structure string `json:"structure"` // Model
}

// AsMap returns a map[string]interface{} that is required for create and update
func (object *BuildingFoundation) AsMap() *map[string]interface{} {
	return &map[string]interface{}{ 
	"locator": object.Locator,
	"site": object.Site,
	"blueprint": object.Blueprint,
	"id_map": object.IDMap,
	"located_at": object.LocatedAt,
	"built_at": object.BuiltAt,
	"updated": object.Updated,
	"created": object.Created,
	"state": object.State,
	"type": object.Type,
	"class_list": object.ClassList,
...
func (service *Contractor) BuildingFoundationGet(id string) (*BuildingFoundation, error) {
	//object := BuildingFoundation{cinp: service.cinp}
...
func (service *Contractor) BuildingFoundationList(filterName string, filterValues map[string]interface{}) <-chan *BuildingFoundation {
	...
	go func() {
		defer close(out)
		object, ok := (<-in).(*BuildingFoundation)
		if ok {
			out <- object
		}
	}()
...
func (object *BuildingFoundation) CallDoCreate() (string, error) {
	args := map[string]interface{}{ }
	_, _, _, ids, _, err := object.cinp.Split(object.GetID())
	if err != nil {
		return "", err
...
func (object *BuildingFoundation) CallDoDestroy() (string, error) {
	args := map[string]interface{}{ }
	_, _, _, ids, _, err := object.cinp.Split(object.GetID())
	if err != nil {
		return "", err
...
func (object *BuildingFoundation) CallDoJob(name string) (string, error) {
	args := map[string]interface{}{ 
		"name": name,
}
	_, _, _, ids, _, err := object.cinp.Split(object.GetID())
...
type BuildingStructure struct {
  ...
  cinp *cinp.CInP
	...
	ConfigUUID string `json:"config_uuid"` // String
...
// AsMap returns a map[string]interface{} that is required for create and update
func (object *BuildingStructure) AsMap() *map[string]interface{} {
	return &map[string]interface{}{ 
	"hostname": object.Hostname,
	"site": object.Site,
	"blueprint": object.Blueprint,
	"foundation": object.Foundation,
	"config_uuid": object.ConfigUUID,
...
func (service *Contractor) BuildingStructureGet(id string) (*BuildingStructure, error) {
	//object := BuildingStructure{cinp: service.cinp}
...
func (service *Contractor) BuildingStructureList(filterName string, filterValues map[string]interface{}) <-chan *BuildingStructure {
	...
	go func() {
		defer close(out)
		object, ok := (<-in).(*BuildingStructure)
		if ok {
			out <- object
		}
	}()
...
// CallDoCreate calls doCreate
func (object *BuildingStructure) CallDoCreate() (string, error) {
	args := map[string]interface{}{ }
	_, _, _, ids, _, err := object.cinp.Split(object.GetID())
	if err != nil {
		return "", err
...
// CallDoDestroy calls doDestroy
func (object *BuildingStructure) CallDoDestroy() (string, error) {
	args := map[string]interface{}{ }
	_, _, _, ids, _, err := object.cinp.Split(object.GetID())
	if err != nil {
		return "", err
...
// CallDoJob calls doJobNone
func (object *BuildingStructure) CallDoJob(name string) (string, error) {
	args := map[string]interface{}{ 
		"name": name,
}
	_, _, _, ids, _, err := object.cinp.Split(object.GetID())
...
type BuildingComplex struct {
  ...
  cinp *cinp.CInP
	...
	BuiltPercentage string `json:"built_percentage"` // Integer
	Updated time.Time `json:"updated"` // DateTime
	Created time.Time `json:"created"` // DateTime
	Members string `json:"members"` // Model
	State string `json:"state"` // String
	Type string `json:"type"` // String
}

// AsMap returns a map[string]interface{} that is required for create and update
func (object *BuildingComplex) AsMap() *map[string]interface{} {
	return &map[string]interface{}{ 
	"name": object.Name,
	"site": object.Site,
...
func (service *Contractor) BuildingComplexGet(id string) (*BuildingComplex, error) {
	//object := BuildingComplex{cinp: service.cinp}
...
type BuildingComplexStructure struct {
	cinp.BaseObject
  cinp *cinp.CInP
	Complex string `json:"complex"` // Model
	Structure string `json:"structure"` // Model
	Updated time.Time `json:"updated"` // DateTime
	Created time.Time `json:"created"` // DateTime
}
...
// AsMap returns a map[string]interface{} that is required for create and update
func (object *BuildingComplexStructure) AsMap() *map[string]interface{} {
	return &map[string]interface{}{ 
...
func (service *Contractor) BuildingComplexStructureGet(id string) (*BuildingComplexStructure, error) {
	//object := BuildingComplexStructure{cinp: service.cinp}
...
func (service *Contractor) BuildingComplexStructureList(filterName string, filterValues map[string]interface{}) <-chan *BuildingComplexStructure {
	...
	go func() {
		defer close(out)
		object, ok := (<-in).(*BuildingComplexStructure)
		if ok {
			out <- object
		}
	}()
...
type BuildingDependency struct {
  ...
  cinp *cinp.CInP
	...
	Foundation string `json:"foundation"` // Model
	ScriptStructure string `json:"script_structure"` // Model
	Link string `json:"link"` // String
	CreateScriptName string `json:"create_script_name"` // String
	DestroyScriptName string `json:"destroy_script_name"` // String
	BuiltAt time.Time `json:"built_at"` // DateTime
	Updated time.Time `json:"updated"` // DateTime
	Created time.Time `json:"created"` // DateTime
	State string `json:"state"` // String
...
// AsMap returns a map[string]interface{} that is required for create and update
func (object *BuildingDependency) AsMap() *map[string]interface{} {
	return &map[string]interface{}{ 
	"structure": object.Structure,
...
func (service *Contractor) BuildingDependencyGet(id string) (*BuildingDependency, error) {
	//object := BuildingDependency{cinp: service.cinp}
...
func (service *Contractor) BuildingDependencyList(filterName string, filterValues map[string]interface{}) <-chan *BuildingDependency {
	...
	go func() {
		defer close(out)
		object, ok := (<-in).(*BuildingDependency)
		if ok {
			out <- object
		}
	}()
