/*Package contractor(version: "0.1") - Automatically generated by cinp-codegen from /api/v1/Utilities/ at 2020-02-28T18:22:28.464196
 */
package contractor
...
type UtilitiesNetworkAddressBlock struct {
	...
	Vlan int `json:"vlan"`
	VlanTagged string `json:"vlan_tagged"`
	Updated time.Time `json:"updated"`
	Created time.Time `json:"created"`
}
...
type UtilitiesNetworkInterface struct {
	...
	cinp *cinp.CInP
	Name string `json:"name"`
	IsProvisioning string `json:"is_provisioning"`
	Network string `json:"network"`
	Updated time.Time `json:"updated"`
	Created time.Time `json:"created"`
}
