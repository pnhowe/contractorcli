/*Package contractor - Automatically generated by cinp-codegen from /api/v1/Survey/ at 2020-02-24T22:51:21.147599
 */
package contractor
...
type SurveyPlot struct {
  ...
  cinp *cinp.CInP
	...
	Corners string `json:"corners"` // String
...
func (object *SurveyPlot) AsMap() *map[string]interface{} {
...
func (service *Contractor) SurveyPlotGet(id string) (*SurveyPlot, error) {
	//object := SurveyPlot{cinp: service.cinp}
...
type SurveyCartographer struct {
	cinp.BaseObject
  cinp *cinp.CInP
	Identifier string `json:"identifier"` // String
...
// AsMap returns a map[string]interface{} that is required for create and update
func (object *SurveyCartographer) AsMap() *map[string]interface{} {
	return &map[string]interface{}{ 
...
func (service *Contractor) SurveyCartographerGet(id string) (*SurveyCartographer, error) {
	//object := SurveyCartographer{cinp: service.cinp}
...
func (service *Contractor) SurveyCartographerList(filterName string, filterValues map[string]interface{}) <-chan *SurveyCartographer {
	...
	go func() {
		defer close(out)
		object, ok := (<-in).(*SurveyCartographer)
		if ok {
			out <- object
		}
	}()
