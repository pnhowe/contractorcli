/*Package contractor - Automatically generated by cinp-codegen from /api/v1/Auth/ at 2020-02-24T22:51:21.147599
 */
package contractor
...
func (object *AuthUser) AsMap() *map[string]interface{} {
...
func (service *Contractor) AuthUserGet(id string) (*AuthUser, error) {
	//object := AuthUser{cinp: service.cinp}
