/*Package contractor - Automatically generated by cinp-codegen from /api/v1/Records/ at 2020-02-24T22:51:21.147599
 */
package contractor
...
func (object *RecordsRecorder) AsMap() *map[string]interface{} {
...
func (service *Contractor) RecordsRecorderGet(id string) (*RecordsRecorder, error) {
	//object := RecordsRecorder{cinp: service.cinp}
...
func (service *Contractor) RecordsRecorderCallQuery(group string, query string, fields string, max_results string) (string, error) {
...
func (service *Contractor) RecordsRecorderCallQuery_objects(group string, query string, max_results string) (string, error) {
	args := map[string]interface{}{ 
		"group": group,
